...
<body>
    ...
    <div class="container"> 
	    ...
	    <div class="span3 sidebar" style="width:15%;height:500 px;margin-top: 10px; -webkit-border-radius: 10px ; -moz-border-radius: 10px ; background: #e6e6e6 ">
             <br>
  ...
  <div style="width:81%;height:auto ; margin-left: auto; margin-top: 10px; -webkit-border-radius: 10px ; -moz-border-radius: 10px ; background: white">
