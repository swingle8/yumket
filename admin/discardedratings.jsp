...
<s:query var="rs" sql="select * from review_restaurant WHERE review_city='${sessionScope.usercity}' AND admin_verify='2'"></s:query>
    ...
    <tr>
       ...
       <c:forEach items="${rs.rows}" var="data">
               <tr><td align="center">${data.review_order_id}</td>
                   ...
                   <td align="center">${data.review_approved_date}</td>
                   <td align="center">${data.review_approvedby}</td>
                   <td align="center">${data.review_discard_reason}</td>
          </tr>
