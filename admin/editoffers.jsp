...
<div class="container">
   ...
   <s:query var="rs" sql="select * from discount_${sessionScope.usercity} Where discount_res_id=${param['res_id']}" ></s:query>            
    
<div class="container">
    <div class="span3 sidebar" style=" width: 100%; height:auto;margin-top: 10px ; margin-left: 20px ; -webkit-border-radius: 10px ; -moz-border-radius: 10px ">
<h4><center><font color="red">Edit Restaurant offers</font></center></h4>
 <c:forEach items="${rs.rows}" var="data">
    <table width="100%">
        <tr><th>
            ...
            <td>
             <input type="text" name="res_pkey" style="width:290px" readonly="true" value="${data.discount_res_id}" />
            </td>
        </tr>    
     </table>
    <form action="../AddRestaurant" accept-charset="utf-8" method="post">
