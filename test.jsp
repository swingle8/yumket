...
<div class="pull-right">
        <form method="post" action="tyo.jsp">
	<input class="span3" id="postcode" name="tyo_num" placeholder="TYO number" type="text"/>
	<button id ="checkpostcode" class="btn btn-large btn-success" type="submit">CHECK STATUS</button>
        </form>
</div>
</div>
...
<table width='100%' cellpadding="0" cellspacing="0" border="0" class="display" id="example" style=" table-layout: fixed">
	<thead>
                    ...
                    <td>hello</td>
                    <td>fello</td> 
                    <td align="center"><h4>Cuisine</h4></td>
                    <td align="center"><h4>Min Order</h4></td>
                    <td align="center"><h4>Delivery cost</h4></td>
                    <td align="center"><h4>Speed</h4></td>
                    <td align="center"><h4>Offers</h4></td>
                    <td align="center"><h4>Rating</h4></td> 
                </tr>
        </thead>
<tbody>
<c:forEach items="${rs.rows}" var="data">
     ...
     <tr onMouseOver="this.bgColor=' #e6e6e6'" onMouseOut="this.bgColor='white' ">
