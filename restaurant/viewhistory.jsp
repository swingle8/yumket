...
<s:query var="rs" sql="select * from cart_details WHERE cart_city='${sessionScope.usercity}' AND cart_Rest_Id='${sessionScope.res_id}' ORDER BY cart_PKey DESC"></s:query>
       ...
       <c:forEach items="${rs.rows}" var="data">
               <tr><td align="center">${data.cart_PKey}</td>
                   ...
                   <td align="center">${data.cart_Servicetype}</td>
                       <td>
                           <a href="orderdetail.jsp?cartid=${data.cart_PKey}&date=${data.cart_Date}" target="#">Detail</a>     
                   </td>
          </tr>
       </c:forEach>
    </table>
