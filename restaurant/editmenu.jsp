...
<div class="container">
  ...
  <s:query var="rs1" sql="select * from item_category_${sessionScope.usercity} Where FK_resDetail_PKey='${sessionScope.res_id}'" ></s:query>            
   <table width="100%">
     ...
     <br>
		...
		<label class="control-label">Category Rank</label>
			<td class="">   
                           ...
                           <input type="hidden" name="res_id" value="${sessionScope.res_id}">
...
<a href="#add-new-item" role="button" data-toggle="modal">Add new Item</a>
   ...
   <s:query var="rs1" sql="select * from item_category_${sessionScope.usercity} Where FK_resDetail_PKey='${sessionScope.res_id}'" ></s:query>            
   <form enctype="multipart/form-data" class="form-horizontal" action="../RestaurantAction" accept-charset="utf-8" method="post">
   <input type="hidden" name="res_id" value="${sessionScope.res_id}">
   <div class='control-group'>
     ...
     <br>
		...
		<label class="control-label">Item details</label>
			<td class="">   
                            <div class='controls'>
                                <input type="text" name="item_details" value="" />
		...
		<label class="control-label">Item pieces</label>
			<td class="">   
               ...
               <div class='control-group'>
		<label class="control-label">Item price (full)</label>
			<td class="">   
                            <div class='controls'>
...
<s:query var="rs2" sql="select * from item_category_${sessionScope.usercity} Where FK_resDetail_PKey='${sessionScope.res_id}' ORDER BY Category_Rank Asc" ></s:query>            
       ...
       <c:forEach items="${rs2.rows}" var="data2">
           ...
           <form method="post" action="../RestaurantAction">
            ...
            <c:set var="itemcatagorypkey" value="${data2.item_Catagory_PKey}"></c:set>
             <s:query var="rs3" sql="select * from menu_item_${sessionScope.usercity} Where FK_resDetails_PKey=${sessionScope.res_id} AND FK_resCategory_PKey=${itemcatagorypkey}">
             </s:query>
